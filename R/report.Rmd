...
source(paste0(root, '/Data analysis/Rcode/helper functions.R'))

# input file
f <- paste0(root, '/SARS/COVID19_VAL_Nucleocapsid_Summary.xlsx')
...
diff <- list(linearity_acon = 'Result (AU/mL)',
             cutpoint_acon = 'Calculated Result from Titer (AU/mL)',
             sens_acon = 'Calculated Result (AU/mL)',
             acc_acon = 'Calculated Result (AU/mL)',
             prec_sheet = 'Precision',
             prec_acon = 'Calculated Result (AU/mL)',
             covr_acon = 'Calculated Result (AU/mL)',
             freez_acon = 'Calculated Result (AU/mL)',
             lip_acon = 'Calculated Result (AU/mL)',
             bili_acon = 'Calculated Result (AU/mL)',
             hemo_acon = 'Calculated Result (AU/mL)',
             heat_acon = 'Calculated Result (AU/mL)',
             conj_acon = 'Calculated Result (AU/mL)',
             antigen_acon = 'Calculated Result (AU/mL)')
...
write_xlsx(list(LLOQ = lloq_sum,
           ...
           path = 'Nucleocapsid_Results.xlsx')
