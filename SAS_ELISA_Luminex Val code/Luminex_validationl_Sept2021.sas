...
%let file = COVID19_Luminex Multiplex Assay Validation Database26Nov21;
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=pres, sheet=PRECISION);
...
%include "O:\HSL\HSL_COVID-19\Chunming Zhu\Data analysis\SAS code\MACROs\mixed_model for_ICC_CV_July2021n.sas";  * start to call macro to calculate CV;
 

%ICC_CV(pres); 


ODS rtf file="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\CVs and ICC for luminex_precision.rtf";
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=LLOQ, sheet=LLOQ);

data lloq;
set lloq;
sample_idd = sample_id;
drop  Result_File;
run;

/***************************************************************************ULOQ data***********************************************************************/

%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=ULOQ, sheet=ULOQ);
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=Linear, sheet=LINEARITY);
...
proc sql; 
 select min(MFI), max(MFI) into: ODmin  , :ODmax  
 from  all_linear;
 quit;
...
data all_linear_1;
 ...
 lg_OD = log((MFI- &ODmin )/(&ODmax- MFI));
lg_dil=log(Dil_Factor);
log_MFI =log(MFI);

if assay in ("CoV1  S" "CoV1 S") then assay="CoV1 S";
if assay in ("M RBD" "Mt.Sinai RBD") then assay="M RBD";
if assay in ("M RBD E484K" "Mt.Sinai RBD E") then assay="M RBD E484K";
if assay in ("M RBD SA" "Mt.Sinai RBD S") then assay="M RBD SA";
if assay in ("M RBD UK" "Mt.Sinai RBD U") then assay="M RBD UK";
if assay in ("Ragon RBD E484" "RagonRBD E484K") then assay="RagonRBD E484K";
 run;


 proc contents data=all_linear_1 varnum;
 run;

proc freq data=all_linear_1;
table assay;
run;
...
select unique assay, Sample_idd as sample_id,  Dil_Factor, count(*) as num_repplicate, exp(mean(lg_acon)) as geomean,  100*std(acon)/mean(acon) as cv, 
				exp(mean(log(result))) as acon_st_m, exp(mean(lg_acon))/ Dil_Factor as geomean_conc /* analyst, day ,*/
from all_linear_1
group by  assay, Sample_idd,  Dil_Factor
;
quit;
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=cut, sheet=CUTPOINT);
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=sens, sheet=LLOQ_Challenge);
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=acc, sheet=ACCURACY);
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=CARRYOVER, sheet=CARRYOVER);
...
/********************************************************************************************************************************************/
/****************************************************Specificity**************************************************************************/
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=Specificity, sheet=Specificity);
...
/********************************************************************************************************************************************/
/********************************** freeze and thraw*****************************************************************************************/
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=Stable_frez_thr, sheet=STABILITY_FREEZE-THAW);
...
/********************************** stability _ Lipedia*****************************************************************************************/
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=Stable_lipe, sheet=STABILITY_LIPEMIA);
...
/**********************************STABILITY_BILIRUBIN*****************************************************************************************/
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=STABILITY_BILIRUBIN, sheet=STABILITY_BILIRUBIN);
...
/**********************************STABILITY_HEMOLYSIS*****************************************************************************************/
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=STABILITY_HEMOLYSIS, sheet=STABILITY_HEMOLYSIS);
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=STABILITY_HEAT, sheet=STABILITY_HEAT);
...
/*******************************************lot to lot Antigen*****************************************************************************************/
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=Lot_Antigen, sheet=Lot-to-Lot Antigen);
...
ODS RTF file="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\Chunming_result\result_28Sep21\COVID19_Spike_lot_antigen.rtf";
...
%importdat(datfile="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\&file", dat=Lot_conjugate, sheet=Lot-to-Lot Conjugate);
...
ODS RTF file="O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\Chunming_result\result_28Sep21\COVID19_Spike_lot_conjugate.rtf";
...
proc import datafile= 'O:\HSL\HSL_COVID-19\Chunming Zhu\SARS\luminex\Validation\COVID19_VAL_Spike_Summary_vFinal_23SEP21.xlsx'
out = Spec
dbms = xlsx
replace;
